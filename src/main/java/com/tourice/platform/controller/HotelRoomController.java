...
import com.tourice.platform.service.BookingService;
...
//    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<RoomResponse> addNewRoom(
        ...
        HotelRoom savedRoom = roomService.addNewRoom(photo, roomType, roomPrice);
    ...
    public ResponseEntity<RoomResponse> updateRoom(@PathVariable Long roomId,
        ...
        HotelRoom theRoom = roomService.updateRoom(roomId, roomType, roomPrice, photoBytes);
    ...
    public ResponseEntity<Optional<RoomResponse>> getRoomById(@PathVariable Long roomId){
        Optional<HotelRoom> theRoom = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<List<RoomResponse>> getAvailableRooms(
        ...
        List<HotelRoom> availableRooms = roomService.getAvailableRooms(checkInDate, checkOutDate, roomType);
        List<RoomResponse> roomResponses = new ArrayList<>();
